...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-teal-700 to-blue-800 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        {/* Logo & Left Links */}
        <div className="flex items-center gap-8">
          <Link
            to="/"
            className="text-2xl font-bold tracking-wide text-white flex items-center"
          >
            <img src="/car.png" className="w-10 h-10 mr-2" alt="Car logo" />
            ...
            <div className="relative inline-block text-left">
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl text-gray-800 z-50 overflow-hidden border border-gray-100">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full text-left px-4 py-2 hover:bg-blue-50 hover:text-blue-700 transition-colors duration-200 border-t border-gray-100"
                  >
                    Logout
                  </button>
                </div>
