...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      >
        <div className="max-w-2xl px-6">
          ...
          <p className="text-lg md:text-xl mb-8 text-blue-100">
            Discover the perfect vehicle for your journey at competitive rates
          </p>
          <button
            onClick={scrollToVehicles}
            className="bg-teal-600 hover:bg-teal-700 px-8 py-3 text-lg font-semibold rounded-lg shadow-md transition-colors duration-300"
          >
            Browse Our Fleet
          </button>
        </div>
      ...
      <section
        ref={vehiclesSectionRef}
        className="py-8 px-4 bg-white shadow-sm"
      >
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-col md:flex-row gap-4">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="flex-grow border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
            />
            <button
              onClick={scrollToVehicles}
              className="bg-blue-700 hover:bg-blue-800 text-white px-6 py-3 rounded-lg shadow transition-colors duration-300"
            >
              Find Vehicles
            </button>
          </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
          Our <span className="text-teal-600">Vehicle</span> Collection
        </h2>
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      {vehicle.availability && (
                        <button
                          onClick={() => handleRentNow(vehicle)}
                          className="w-full bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 rounded-lg transition-colors duration-300 font-medium"
                        >
                          Rent Now
                        </button>
                      )}
      ...
      <footer className="bg-gray-900 text-white pt-16 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 flex items-center">
                <span className="bg-teal-600 w-1 h-6 mr-2 rounded-full"></span>
                About Us
              </h3>
              <p className="text-gray-400">
                Your trusted partner for premium vehicle rentals with
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#"
                    className="text-gray-400 hover:text-teal-400 transition-colors duration-200 flex items-center"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-teal-400 mt-0.5 mr-2 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div>
              ...
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="px-4 py-2 w-full rounded-l-md focus:outline-none text-gray-900 focus:ring-2 focus:ring-teal-500"
                />
                <button className="bg-teal-600 hover:bg-teal-700 px-4 py-2 rounded-r-md transition-colors duration-300">
                  Subscribe
                </button>
              </div>
        ...
        {/* Hidden SVG icons for social media */}
